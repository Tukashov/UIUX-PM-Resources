...
function Header() {
    return (
        <header className='Header'>
            <div className='container'>
                <div className='Header__Inner'>
                    <div className='Header__Inner__Logo'>
                        <NavLink to='/' className='Header__Inner__Logo__Link'>WiKi</NavLink>
                    </div>

                    <nav className='Header__Inner__Nav'>
                        <ul className='Header__Inner__Nav__List'>
                            <li className='Header__Inner__Nav__List__Item'>
                                <NavLink to='/' className='Header__Inner__Nav__List__Item__Link'>UI/UX</NavLink>
                            </li>
                    ...
                    <div className='Header__Inner__SocialIcons'>
                        <a href='/' className='Header__Inner__SocialIcons__Link'>
            ...
            <Routes>
                <Route path="/" element={<UIUX />} />
                <Route path="/product-menegment" element={<PM />} />
            </Routes>
        </header>
    )
}
